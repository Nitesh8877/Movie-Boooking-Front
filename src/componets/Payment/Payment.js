...
const Payment = (props) => {
    ...
    const finalizePayment = async () => {
        const data = {
            bookingId: bookingDetail.data._id,
            amount: bookingDetail.data.totalCost
        }
        console.log(data)
                ...
                <Modal.Body>
                    ...
                    <div className='row fw-lighter'>
                        ...
                        <div className="row">
                            ...
                            <div className="col-2"> <p className='fw-bolder'>Rs.{props.price}</p></div>
                        ...
                        </div>
                        {
                            paymentDetail.status === "SUCCESS" ? (
                                ...
                                <div className="bg-success py-1  text-white text-center shadow-lg rounded-3 bg-opacity-75 ">
                                   <div>After One minutes redirect home page</div> 
